...
const OurClient = () => {
	return (
		...
		>
			<div className=" relative top-10 left-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-0 bg-slate-50 z-0 justify-items-center  rounded-tl-3xl rounded-br-3xl">
				...
				<img
					...
					alt="clientimg"
					className="w-fit h-fit object-cover left-0 rounded-br-3xl"
				/>
			</div>
