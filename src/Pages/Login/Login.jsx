						...
						<div className="text-center lg:text-left">
							<div className="grid grid-cols-2">
								<div className="flex items-center flex-col justify-center">
									...
									<p className="py-6">
										Social media is a term for websites and apps that allow
										users to share content, ideas, and information. It also
										refers to the online communities that users create to share
										personal messages
									</p>
								</div>
