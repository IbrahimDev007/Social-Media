						...
						<div className="text-center lg:text-left">
							<div className="grid grid-cols-2">
								<div className="flex items-center flex-col justify-center">
									...
									<p className="py-6">
										Social media registers are online platforms where users can
										create profiles and connect with others. They offer a
										variety of features, such as the ability to share photos,
										videos, and messages, as well as to follow other users and
										join groups.
									</p>
								</div>
